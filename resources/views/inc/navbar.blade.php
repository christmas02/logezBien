              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                ...
                <a class="dropdown-item preview-item">
                  ...
                  <div class="preview-item-content">
                    <h6 class="preview-subject font-weight-normal text-dark mb-1">Nouvelle propriété à &nbsp; &nbsp;</h6>
                    <p class="font-weight-light small-text mb-0">
                      {{$notifie->data['message']}}
                    </p>
                  </div>
                  <form action="{{route('admin.notification.update', $notifie->id)}}" method="POST">
									{{csrf_field()}}
                ...
                @foreach($notificationAd as $notifies)
                <div class="dropdown-divider"></div>
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <div class="preview-icon bg-inverse-warning">
                  ...
                  <div class="preview-item-content">
                    <h6 class="preview-subject font-weight-normal text-dark mb-1">Vous avez une nouvelle reservation de &nbsp; &nbsp;</h6>
                    <p class="font-weight-light small-text mb-0">
                      {{$notifies->data['name']}}
                    </p>
                  </div>
                  <form action="{{route('admin.notification.update', $notifies->id)}}" method="POST">
									{{csrf_field()}}
									<div class="pull-right" width="50">
										<button type="submit"  class="btn btn-success" title="marquer comme lu" ><i class="fa fa-check-square"></i></button>
									</div>
        ...
        <ul class="nav page-navigation">
          <li class="nav-item">
            <a href="{{route('admin')}}" class="nav-link">
              ...
              <span class="menu-title">Tableu de bord</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <span class="menu-title">Proprietaire</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="submenu">
              <ul class="submenu-item">
                <li class="nav-item">
                  <a class="nav-link" href="{{route('Utilisateurs')}}">Liste</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{route('user.create')}}">Creer un Proprietaire</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <!--<li class="nav-item">
           ...
           <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="link-icon icon-location-pin"></i>
            ...
            <div class="submenu">
              <ul class="submenu-item">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('commune.create') }}">Ajouter une localisation</a>
                </li>
              </ul>
            </div>
           </li>
           ...
           <li class="nav-item">
            ...
            <div class="submenu">
              <ul class="submenu-item">
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('reservationbackend.index') }}">Liste des Réservations</a>
                </li>
                <!--<li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <div class="submenu">
              <ul class="submenu-item">
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('appartement.index') }}">Liste</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('appartement.create') }}">Ajouter un appartement</a>
                </li>
              </ul>
            </div>
           </li>
